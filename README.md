...
> Nota: la configuración de cinco roles descrita en esta sección fue reemplazada por el sistema V10.0 al final de este archivo. Usa `DISCORD_ROLE_RULES`, no `DISCORD_COLLECTION_ROLES`.
...
## Actualización V10.0 — Colección, Dominio y Especiales
...
### Secretos de Supabase para V10.0
